...
import java.util.function.Supplier;
    public class CreeperIngotFromMob extends LootModifier {

        public static final Supplier<Codec<CreeperIngotFromMob>> CODEC =
                ...
                ).apply(inst, CreeperIngotFromMob::new)));
         ...
         */
        public CreeperIngotFromMob(LootItemCondition[] conditionsIn, Item ingot) {
            super(conditionsIn);
            this.ingot = ingot;
        }
