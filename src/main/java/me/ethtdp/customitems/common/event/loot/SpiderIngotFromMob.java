...
public class SpiderIngotFromMob extends LootModifier {

    public static final Supplier<Codec<SpiderIngotFromMob>> CODEC =
            ...
            ).apply(inst, SpiderIngotFromMob::new)));
     ...
     */
    public SpiderIngotFromMob(LootItemCondition[] conditionsIn, Item ingot) {
        super(conditionsIn);
        this.ingot = ingot;
    }
