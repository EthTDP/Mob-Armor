...
public class ZombieIngotFromMob extends LootModifier {

    public static final Supplier<Codec<ZombieIngotFromMob>> CODEC =
            ...
            ).apply(inst, ZombieIngotFromMob::new)));
     ...
     */
    public ZombieIngotFromMob(LootItemCondition[] conditionsIn, Item ingot) {
        super(conditionsIn);
        this.ingot = ingot;
    }
