package me.ethtdp.customitems.common.event.loot.warden.chest;
...
public class WardenArmorFromChestAdditionModifier extends LootModifier {

        public static final Supplier<Codec<WardenArmorFromChestAdditionModifier>> CODEC =
            Suppliers.memoize(() -> RecordCodecBuilder.create(inst -> codecStart(inst).and(
                    ...
                    .apply(inst, WardenArmorFromChestAdditionModifier::new)
            ));
     ...
     */
    public WardenArmorFromChestAdditionModifier(LootItemCondition[] conditionsIn, Item helmet, Item chestplate, Item leggings, Item boots) {
        super(conditionsIn);
        this.helmet = helmet;
